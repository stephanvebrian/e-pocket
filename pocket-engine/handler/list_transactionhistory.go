...
func (h *handler) ListTransactionHistory(w http.ResponseWriter, r *http.Request) {
	context := r.Context()
	...
	req := handlerModel.ListTransactionHistoryRequest{
		UserID: userID,
	}

	response, err := h.transactionHistoryLogic.ListTransactionHistory(context, req)
